...
build:
	go build -o CGO_ENABLED=0 ${BINARY}
...
release:
	...
	GOOS=linux GOARCH=386 go build -o CGO_ENABLED=0 ./bin/${VERSION}/linux_386/${BINARY}_v${VERSION}
	GOOS=linux GOARCH=amd64 go build -o CGO_ENABLED=0 ./bin/${VERSION}/linux_amd64/${BINARY}_v${VERSION}
	GOOS=linux GOARCH=arm go build -o CGO_ENABLED=0  ./bin/${VERSION}/linux_arm/${BINARY}_v${VERSION}
	GOOS=windows GOARCH=386 go build -o CGO_ENABLED=0  ./bin/${VERSION}/windows_386/${BINARY}_v${VERSION}
	GOOS=windows GOARCH=amd64 go build -o CGO_ENABLED=0  ./bin/${VERSION}/windows_amd64/${BINARY}_v${VERSION}
	GOOS=darwin GOARCH=amd64 go build -o CGO_ENABLED=0  ./bin/${VERSION}/darwin_amd64/${BINARY}_v${VERSION}
	GOOS=darwin GOARCH=arm64 go build -o CGO_ENABLED=0  ./bin/${VERSION}/darwin_arm64/${BINARY}_v${VERSION}
